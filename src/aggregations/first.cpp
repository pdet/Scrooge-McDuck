...
std::unique_ptr<duckdb::FunctionData> BindGenericRoundFunctionDecimal(
...
void FirstScrooge::RegisterFunction(duckdb::Connection &conn,
  ...
  //   first.AddFunction(GetFirstScroogeFunction(duckdb::LogicalType::DOUBLE));
  //   first.AddFunction(GetFirstScroogeFunction(duckdb::LogicalType::FLOAT));
